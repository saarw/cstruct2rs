use std::libc::{c_void, c_uchar, c_float, c_ulong, c_double, c_char, c_ushort, c_int, c_short, c_uint};

#[repr(C)]
pub struct libraw_decoder_info_t {
	pub decoder_name: *const const,
...
pub struct libraw_callbacks_t {
	...
	pub progresscb_data: *const c_void,
	pub exif_cb: exif_parser_callback,
	pub exifparser_data: *const c_void,
}
...
pub struct libraw_output_params_t {
	...
	pub output_profile: *const c_char,
	pub camera_profile: *const c_char,
	pub bad_pixels: *const c_char,
	pub dark_frame: *const c_char,
...
pub struct libraw_rawdata_t {
	pub raw_alloc: *const c_void,
	pub raw_image: *const c_ushort,
	pub color4_image: [*const c_ushort; 4],
	pub color3_image: [*const c_ushort; 3],
	pub ph1_cblack: [*const c_short; 2],
	pub ph1_rblack: [*const c_short; 2],
